...
//             for Bernoulli (alternative) GLM with logit link
//             
//
...
// =================================================================================
//
#ifndef _LOGLIK_BERNOULLI_LOGIT_H_
#define _LOGLIK_BERNOULLI_LOGIT_H_
...
//                                    eta[i] = t(x[,i]) %*% theta
//
//  pi[n]:                    INPUT:  whatsever
//                           OUTPUT:  current value of the Bernoulli mean (probability of success)
...
//                  
//  y[n]:                      observed 0/1 outcome
//
//  null[0]:                   nowhere used, it is here only to have the same prototype as LogLik_Poisson_Log
//
