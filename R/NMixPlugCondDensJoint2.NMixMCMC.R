...
##  CREATED:   29/05/2009
##
##  FUNCTIONS: NMixPlugCondDensJoint2.NMixMCMC (29/05/2009)
##             
## ======================================================================
...
## *************************************************************
NMixPlugCondDensJoint2.NMixMCMC <- function(x, icond, grid, lgrid=50, scaled=FALSE, ...)
{
  ...
  return(NMixPlugCondDensJoint2.default(x=grid, icond=icond, scale=scale, w=x$poster.mean.w, mu=x$poster.mean.mu, Sigma=x$poster.mean.Sigma))
}  
