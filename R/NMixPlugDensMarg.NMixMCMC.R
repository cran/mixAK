...
## *************************************************************
NMixPlugDensMarg.NMixMCMC <- function(x, grid, lgrid=50, scaled=FALSE, ...)
{
  ...
  return(NMixPlugDensMarg.default(x=grid, scale=scale, w=x$poster.mean.w, mu=x$poster.mean.mu, Sigma=x$poster.mean.Sigma))
}  
